...
export class Backend implements backendInterface {
    ...
    async getAllGreetings(): Promise<Array<Greeting>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllGreetings();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getGreeting(arg0: string): Promise<Greeting> {
        if (this.processError) {
            try {
    ...
    async greet(arg0: string): Promise<Greeting> {
        if (this.processError) {
            try {
